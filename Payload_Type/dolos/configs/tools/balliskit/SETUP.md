# Balliskit Tool Setup

Balliskit includes ShellcodePack and MacroPack, commercial tools from balliskit.com.
...
If your server already has these tools installed, set `install_tools: false` in the encoder profile.
