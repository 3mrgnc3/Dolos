...
# Auto-import every module in agent_functions/ so their PayloadType / CommandBase
# subclasses register with mythic_container (same pattern as MythicAgents/bloodhound).
